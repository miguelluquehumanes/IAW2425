...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $id = mysqli_real_escape_string($enlace, htmlspecialchars(trim($_GET['id']))); // Usar el ID de la URL
...
<body>
    <div class="container">
        ...
        <form method="POST" action="modificar_actividad2.php?id=<?php echo $actividad['id']; ?>">
